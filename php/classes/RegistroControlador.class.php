<?php
class RegistroControlador extends Registro
{
    ...
    public function registrarUsuario(): void
    {
        ...
        echo (new Respuesta(Respuesta::URL, "inicio-sesion.php?{$nombreUsuarioUrl}"))->Json();
    }
    ...
    // private function clavesCoincidentes(): bool
    // {
    //     return strcmp($this->clave, $this->claveVerificacion) === 0;
    // }
}
